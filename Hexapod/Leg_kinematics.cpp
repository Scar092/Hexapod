...
private:
	...
	// delta_len - это плечо от оси корневой сервы до оси средней. ќно не поднимаетс€ вверх, а потому
	// не участвует в кинематике следующих двух плеч. ќно двигаетс€ только в плоскости ху.
	// Ќоль координат х и у будет в точке оси коревой сервы, а по оси z на уровне оси средней сервы.
